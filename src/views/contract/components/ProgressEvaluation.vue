...
<template>
  ...
  <div class="eval-cont">
    ...
    <p>
      <span
        @click="evalTypeClick(1)"
        :class="state.evalType == 1 ? 'active' : ''"
        >通过</span
      >
      <span
        @click="evalTypeClick(2)"
        :class="state.evalType == 2 ? 'active' : ''"
        >有风险</span
      >
      <span
        @click="evalTypeClick(3)"
        :class="state.evalType == 3 ? 'active' : ''"
        >问题严重</span
      >
    </p>
    <van-field
